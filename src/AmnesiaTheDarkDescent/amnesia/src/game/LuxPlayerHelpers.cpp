...
void cLuxPlayerDeath::Start()
{
	...
	//////////////////////////////////
	//Text
	if (msHintCat == "StreamnesiaLiteral")
	{
		std::wstring wLiteralHint(msHintEntry.length(), L' ');
		std::copy(msHintEntry.begin(), msHintEntry.end(), wLiteralHint.begin());
		
		msCurrentHintText = wLiteralHint;
	}
	else
	{
